...
{
    public class DescricaoErroPortugues : IdentityErrorDescriber
    {
        ...
        public override IdentityError RecoveryCodeRedemptionFailed()
        {
            ...
            return new IdentityError { Code = nameof(RecoveryCodeRedemptionFailed), Description = "Login Invalido" };
